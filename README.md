...
- [MySigMail](https://mysigmail.com/) - A free and open-source email signature generator for Gmail, Outlook, Apple Mail, etc. ([Source Code](https://github.com/antonreshetov/mysigmail)) `AGPL-3.0` `Nodejs`
